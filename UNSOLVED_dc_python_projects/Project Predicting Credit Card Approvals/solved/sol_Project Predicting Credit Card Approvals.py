...
print("mean:",cc_apps.mean())

#################

print("Numeric columns name:",cc_apps.select_dtypes([np.number]).columns)
...
present in the columns having numeric data-types (columns 2, 7, 10 and 14).

numerical missing data got filled with mean of respective cols.
'''
...
'''
 converting all the non-numeric values into numeric ones
  many machine learning models (like XGBoost) (and especially the
  ones developed using scikit-learn)
  require the data to be in a strictly numeric format.
  
  https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.LabelEncoder.html
 '''
print("non numeric columns:",cc_apps.select_dtypes(exclude='int64'))
print("done")
# Import LabelEncoder
...
#cc_apps.drop(['DriversLicense','ZipCode'])
...
max_iter = [i for i in range(100,201,50)]
